...
body {
    background: linear-gradient(rgba(246, 247, 249, 0.8), rgba(246, 247, 249, 0.8)), url(http://eliteproducts.in/apurinks/my/Develop/sea2.jpg) no-repeat center center fixed;
...
.frame {
    height: 575px;
    width: 430px;
    background: linear-gradient(rgba(35, 43, 85, 0.75), rgba(35, 43, 85, 0.95)), url(http://eliteproducts.in/apurinks/my/Develop/sea2.jpg) no-repeat center center;
    background-size: cover;
    margin-left: auto;
    margin-right: auto;
...
if($_POST['submit'])
{
  ...
  {
    $login_error='<font color="red"><center>Please Check Username and Password !!</center></font>';
  } 
}
...
{ 
  ...
  else 
  {
    //header('Location: index.php');    
    $login_error='<font color="red"><center>Please Check Username and Password !!</center></font>';
    //echo'<font color="red"><center>Please Check Username and Password !!</center></font>';
  } 
}
...
?>
    ...
    <div class="frame">
        <div class="nav">
            <ul class="links">
                <li class="signin-active"><a class="btn" style="padding-left:100px;">Sign in</a></li>
            </ul>
        </div>

        <div ng-app ng-init="checked = false">
          <form class="form-signin" action="login.php" method="post" name="login">
           <label for="username">Username</label> <input class="form-styling" type="text" name="username" placeholder="" autofocus required/>
           <label for="password">Password</label> <input class="form-styling" type="password"  value="" name="password" placeholder="" required/> 
           <div> <input type="submit" class="btn-animate" value="Sign in"></div>
          </form>
