...
<table class=" table-hover"  width="100%">		
	<form name="engcomments" action="index.php" method="post">
		...
		<tr><td id="numaligncenter" colspan="6" style="font-size:20px;">Work Done</td></tr>	
		<tr>
			<td id="numaligncenter">Date</td>
			<td id="numaligncenter">Description</td>
			<td id="numaligncenter">Frequency</td>
			<td id="numaligncenter">Done By</td>	
			<td id="numaligncenter">Approved By</td>
		</tr>
		<tr>		
		...
		<tr>
			<td colspan="6"><button name="srengcomments" class="btn btn-block btn-sm btn-primary" value="srengcomments">Save</button></td>
		</tr>
</form>	
</table>
 <?php
if($_POST['srengcomments'])
{
	...
	//print_r($_POST);
	 ...
	 $sqll="INSERT INTO `engworkdone` (`reportnum`, `voynum`,`ddatetime`, `testing`, `freq`, `testby`, `appby`, `comments`) 
...
?>
<table width="85%">
	<tr><td colspan="2"><center><h4> Work Lists</h4></center></td></tr>
...
<?php
		...
		$sql10=mysqli_query($con,"SELECT * FROM engworkdone where reportnum =$reportnum");
